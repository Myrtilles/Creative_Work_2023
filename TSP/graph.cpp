...
void Graph::createTabWidget(const QRectF &rect){
    ...
    tab->addTab(TSTab, tr("Коммивояжёр"));
    tab->addTab(graphTab, tr("Граф"));

    QHBoxLayout *vertexTabLayout = new QHBoxLayout;
    QPushButton *addVertexButton = new QPushButton();
    addVertexButton->setText(tr("Добавление вершины"));
    addVertexButton->setFont(textfont);
    addVertexButton->setMaximumSize(QSize(300, 50));
    addVertexButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                                   "QPushButton:pressed{background-color: lightGreen;} "
                                   "QPushButton{height: 30px; width: 30px; background-color: lightGreen; border-right, border-bottom: 4px solid Gray;}");
    connect(addVertexButton, &QPushButton::clicked, this, &Graph::insertVertex);

    QPushButton *eraseVertexButton = new QPushButton();
    eraseVertexButton->setText(tr("Удаление вершины"));
    eraseVertexButton->setFont(textfont);
    eraseVertexButton->setMaximumSize(QSize(300, 50));
    eraseVertexButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                                   "QPushButton:pressed{background-color: Pink;} "
                                   "QPushButton{height: 30px; width: 30px; background-color: Pink; border-right, border-bottom: 4px solid Gray;}");
    ...
    addEdgeButton->setText(tr("Добавление ребра"));
    addEdgeButton->setFont(textfont);
    addEdgeButton->setMaximumSize(QSize(200, 50));
    addEdgeButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                                 "QPushButton:pressed{background-color: lightGreen;} "
                                 "QPushButton{height: 30px; width: 30px; background-color: lightGreen; border-right, border-bottom: 4px solid Gray;}");
    connect(addEdgeButton, &QPushButton::clicked, this, &Graph::createAddEdgeWindow);

    QPushButton *updateWeightButton = new QPushButton();
    updateWeightButton->setText(tr("Обновление веса ребра"));
    updateWeightButton->setFont(textfont);
    updateWeightButton->setMaximumSize(QSize(220, 50));
    updateWeightButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                                  "QPushButton:pressed{background-color: lightYellow;} "
                                  "QPushButton{height: 30px; width: 30px; background-color: lightYellow; border-right, border-bottom: 4px solid Gray;}");
    ...
    eraseEdgeButton->setText(tr("Удаление ребра"));
    eraseEdgeButton->setFont(textfont);
    eraseEdgeButton->setMaximumSize(QSize(200, 50));
    eraseEdgeButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                                 "QPushButton:pressed{background-color: Pink;} "
                                 "QPushButton{height: 30px; width: 30px; background-color: Pink; border-right, border-bottom: 4px solid Gray;}");
    ...
    functionButton->setStyleSheet("QToolButton:selected, QToolButton:hover{color: white;} "
                             "QToolButton:pressed{background-color: lightYellow;} "
                             "QToolButton{height: 30px; width: 30px; background-color: lightYellow; border-right, border-bottom: 4px solid Gray;}");
    ...
    resetButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                             "QPushButton:pressed{background-color: Pink;} "
                             "QPushButton{height: 30px; width: 30px; background-color: Pink; border-right, border-bottom: 4px solid Gray;}");
    ...
    clearButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                             "QPushButton:pressed{background-color: Pink;} "
                             "QPushButton{height: 30px; width: 30px; background-color: Pink; border-right, border-bottom: 4px solid Gray;}");
    connect(clearButton, &QPushButton::clicked, this, &Graph::clear);

    QPushButton *functionsInfoButton = new QPushButton();
    functionsInfoButton->setText(tr("Инф. о методах"));
    functionsInfoButton->setFont(textfont);
    functionsInfoButton->setMaximumSize(QSize(200, 50));
    functionsInfoButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                             "QPushButton:pressed{background-color: lightYellow;} "
                             "QPushButton{height: 30px; width: 30px; background-color: lightYellow; border-right, border-bottom: 4px solid Gray;}");
    ...
    matrixInfoButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                             "QPushButton:pressed{background-color: lightYellow;} "
                             "QPushButton{height: 30px; width: 30px; background-color: lightYellow; border-right, border-bottom: 4px solid Gray;}");
    connect(matrixInfoButton, &QPushButton::clicked, this, &Graph::getMatrixInfo);

    QHBoxLayout *TSTabLayout = new QHBoxLayout;
    ...
    findShortPath->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                                 "QPushButton:pressed{background-color: lightYellow;} "
                                 "QPushButton{height: 30px; width: 30px; background-color: lightYellow; border-right, border-bottom: 4px solid Gray;}");
    ...
    clearLineButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: white;} "
                                 "QPushButton:pressed{background-color: Pink;} "
                                 "QPushButton{height: 30px; width: 30px; background-color: Pink; border-right, border-bottom: 4px solid Gray;}");
    ...
    TSTabLayout->addWidget(findShortPath);
    TSTabLayout->addWidget(shortestPath);
    TSTabLayout->addWidget(clearLineButton);

    vertexTab->setLayout(vertexTabLayout);
    edgeTab->setLayout(edgeTabLayout);
    graphTab->setLayout(graphTabLayout);
    TSTab->setLayout(TSTabLayout);
...
void Graph::travellingSalesman(int vertexIndex,QLineEdit *line)
{
    ...
    vertexList[vertexIndex]->setColor("magenta");
    //Цвет ребер кратчайшего пути меняется на лиловый
    for(int i=0;i<vertexNum;i++)
    {
